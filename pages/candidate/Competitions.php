...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-md-6">
        <h4 class="m-0 text-dark">Competitions</h4>
      </div>
      <div class="col-md-6">
          ...
          <div class="card-body">
            ...
            <form method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="" placeholder="Competition Name "
                 ...
                 <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" name="" placeholder="Chief Guest"
                    class="form-control" autocomplete="off"
                    required>
                  </div>
                </div>
                 ...
                 <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" name="" placeholder="Number of Students"
                    class="form-control" autocomplete="off"
                    required>
                  </div>
                </div>
