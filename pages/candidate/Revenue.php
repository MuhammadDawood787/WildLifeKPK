...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-md-6">
        <h4 class="m-0 text-dark">Revenue Of Wildlife Department KPK</h4>
      </div>
      <div class="col-md-6">
        <ol class="breadcrumb float-md-right">
          <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
          <li class="breadcrumb-item active">Revenue Of Wildlife Department KPK</li>
        </ol>
      </div>
    </div>
  </div>
      ...
      <div class="col-md-12">
        ...
        <div class="card card-success" class="text-center">
          <div class="card-header">
            <div class="card-title">Revenue Of Wildlife Department KPK</div>
          ...
          <div class="card-body">
            ...
            <form method="post" enctype="multipart/form-data">
                 ...
                 <div class="col-md-4">
                  ...
                  <div class="form-group">
                    <label>Target</label>
                    <input type="text" name="" placeholder="Target"
                    class="form-control" autocomplete="off"
                    required>
                  </div>
                </div>
                 <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" name="" placeholder="Achievement"
                    class="form-control" autocomplete="off"
                    required>
                  </div>
                </div>
